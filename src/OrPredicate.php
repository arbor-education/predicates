...
/**
 * Predicate implementation that returns true if either of predicates return true.
 *
 * @package Dutek\Predicate
 * @author Dušan Vejin <dutekvejin@gmail.com>
 */
final class OrPredicate implements PredicateDecorator
{
     ...
     * @return bool true if either decorated predicate returns true
     */
